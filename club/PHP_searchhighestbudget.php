...
if (!$conn) {
  ...
  $type = strval($_POST["typeList"]);
        ...
        $sql = "Select c.clubName, b0.year, b0.amountTotal From Club c, Budget b0 Where b0.amountTotal > (Select b1.amountTotal From Budget b1 Where b1.clubID <> b0.clubID limit 1) And year = 2022 order by amountTotal desc limit 1;";   // this searches with year, clubid, name, and type if they are inputted
